...
5.times do
  guitar = Guitar.new(model: Faker::Music::RockBand.name, level: Guitar::LEVEL.sample, brand: Faker::Music::Phish.song, genre: Faker::Music.genre, price_per_day: rand(1..100))
  guitar.user = user1
  guitar.save!
end
